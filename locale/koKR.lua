...
L.ChatFeaturesDisabledInstance = "xanChat: Blizzard 제한으로 인해 인스턴스에서 일부 기능이 비활성화될 수 있습니다."
L.ChatFeaturesDisabledLockdown = "xanChat: Blizzard 전투 제한으로 인해 일부 채팅 기능이 비활성화될 수 있습니다."
L.ChatFeaturesEnabled = "xanChat: 채팅 기능이 다시 활성화되었습니다."
L.ChatSettingsLockedRestricted = "xanChat: 전투/인스턴스 제한 동안 설정이 잠겨 있습니다."
