...
L.ProtectedChannel = "¡¡Canal protégé par Blizzard. Accès addon interdit.¡¡"
L.ProtectedSecretValue = "¡¡Le message de discussion contient des <valeurs secrètes>. L'accès est interdit par Blizzard.¡¡"

L.ChatFeaturesDisabledInstance = "xanChat : Certaines fonctions peuvent être désactivées en instance en raison de restrictions de Blizzard."
L.ChatFeaturesDisabledLockdown = "xanChat : Certaines fonctions du chat peuvent être désactivées en raison des restrictions de rencontre de Blizzard."
L.ChatFeaturesEnabled = "xanChat : Fonctions de chat réactivées."
L.ChatSettingsLockedRestricted = "xanChat : Les paramètres sont verrouillés pendant les restrictions de rencontre/instance."
...
-- French channel name patterns for SHORT flexible matching
L.ChannelPatternShortGeneral = "général"
L.ChannelPatternShortTrade = "commerce"
L.ChannelPatternShortWorldDefense = "défenseglobale"
L.ChannelPatternShortLocalDefense = "défenselocale"
L.ChannelPatternShortLookingForGroup = "recherchedegroupe"
L.ChannelPatternShortGuildRecruitment = "recrutementdeguilde"
L.ChannelPatternShortNewcomerChat = "nouveaux"

-- Channel name patterns for flexible matching
L.ChannelNameGeneral = "[Gg]énéral"
L.ChannelNameTrade = "[Cc]ommerce"
L.ChannelNameWorldDefense = "[Dd]éfense[Gg]lobal"
L.ChannelNameLocalDefense = "[Dd]éfense[Ll]ocale"
L.ChannelNameLookingForGroup = "[Rr]echerche[Dd]e%s*[Gg]roupe"
L.ChannelNameGuildRecruitment = "[Rr]ecrutement[Dd]e%s*[Gg]uilde"
L.ChannelNameNewcomerChat = "[Dd]iscussion%s*[Dd]es%nouveaux"
...
L.ChannelPatternGeneral = "(%[%d+%. ]*Général[%s%-].-])"
L.ChannelPatternTrade = "(%[%d+%. ]*Commerce[%s%-].-])"
L.ChannelPatternWorldDefense = "(%[%d+%. ]*DéfenseGlobale[%s%-].-])"
L.ChannelPatternLocalDefense = "(%[%d+%. ]*DéfenseLocale[%s%-].-])"
L.ChannelPatternLookingForGroup = "(%[%d+%. ]*RechercheDeGroupe[%s%-].-])"
L.ChannelPatternGuildRecruitment = "(%[%d+%. ]*RecrutementDeGuilde[%s%-].-])"
L.ChannelPatternNewcomerChat = "(%[%d+%. ]*Discussion des nouveaux[%s%-].-])"
...
L.EditFilterListInfo = "Les événements cochés seront stylisés dans le chat."
